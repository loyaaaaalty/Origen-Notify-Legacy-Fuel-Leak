...
Config.Strings = {
	...
	FullTank = "El deposito esta lleno",
	PurchaseJerryCan = "~y~E~w~ comprar un bidon por $" .. Config.JerryCanCost,
	CancelFuelingPump = "~y~E~w~ cancelar",
	CancelFuelingJerryCan = "~y~E~w~ cancelar",
	NotEnoughCash = "No tienes dinero",
	RefillJerryCan = "~y~E~w~ rellenar bidon",
	NotEnoughCashJerryCan = "No tienes dinero",
	JerryCanFull = "Bidon lleno",
	TotalCost = "Coste",
	PurchaseJerryCan = "~y~E~w~ coger un bidon",
	RefillJerryCan = "~y~E~w~ rellenar el bidon",
}
